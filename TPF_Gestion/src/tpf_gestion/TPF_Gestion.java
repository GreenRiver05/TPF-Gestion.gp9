...
//        tarea.setIdTarea(1);
//        Comentarios comentario = new Comentarios(tarea, "Terminando las Pruebas del Main Gestion", LocalDate.of(2022, 12, 1));
...
//        Tarea tarea = new Tarea();
//        tarea.setIdTarea(1);
//        Comentarios comentario = new Comentarios(5,tarea, "Terminando las Pruebas en main Gestión", LocalDate.of(2022, 6, 13));
//        comData.modificarCometario(comentario);


//..........ELIMINAR//

//        ComentarioData comData = new ComentarioData();
//        comData.eliminarComentario(7);
    }
}
